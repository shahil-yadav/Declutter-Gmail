...
// todo: these are not related to my project
var MsgFlags = map[int]string{
	SUCCESS:             "ठीक है",
	ERROR:               "असफल",
	STATUS_BAD_REQUEST:  "स्थिति ख़राब अनुरोध",
	STATUS_UNAUTHORIZED: "अनाधिकृत स्थिति",

	// related to users in mysql
	ERROR_ADD_USER_FAIL: "उपयोगकर्ता जोड़ने में विफल।",

	// related to /mails
	ERROR_GET_MAILS_FAILS:        "मेल प्राप्त करने में विफल",
	ERROR_GET_MAILS_FOLDER_FAILS: "मेल फ़ोल्डर प्राप्त करने में विफल",
	ERROR_ADD_MAILFETCH_FAIL:     "`mails_fetch` तालिका में प्रविष्टि जोड़ने में विफल",
